...
interface CellInterface {
  v: Date | number | boolean | string // 单元格值
  t: string // 数据类型
  z: string // 格式化字符串
}

// 自定义 Workbook 类，实现 WorkBook 接口
class Workbook implements XLSX.WorkBook {
  SheetNames: string[] = [] // 工作表名称数组
  Sheets: { [sheet: string]: XLSX.WorkSheet } = {} // 工作表对象字典
}
